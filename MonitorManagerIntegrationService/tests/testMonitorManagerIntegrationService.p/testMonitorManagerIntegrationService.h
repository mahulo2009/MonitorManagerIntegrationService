...
extern "C" int testMonitorManagerIntegrationService(char* devicename,int updateProfile=0,int mode=0,long priority=100,unsigned threads=4,int corbaDebug=0);
#else
